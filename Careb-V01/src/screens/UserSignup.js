                            ...
                            <div className='detail' style={{ padding: 20 }}>
                                <div style={{
                                    ...
                                    <div style={{flexDirection: 'row', display: 'flex'}}>
                                        <a href='https://www.facebook.com/profile.php?id=61557976032264&mibextid=ZbWKwL'>
                                            <img style={{width: 25, height: 25, marginRight: 10}} src={Faceboos}
                                                 alt=''/></a>
                                        ...
                                        <a href='https://www.instagram.com/caribbeaneaze?igsh=MWZ2eTR0M3ByZ21h'> <img
                                            style={{width: 25, height: 25, marginRight: 10}} src={Instagram}
                                            alt=''/></a>
                                    </div>
                                </div>
                                <div className='signup-descap'>
                                    <p>
                                        ...
                                        Discover our collection of Caribbean properties, from luxurious villas and cozy
                                        cottages to
                                        beachfront homes and budget-friendly stays. Whether you seek tranquility or
                                        adventure,
                    ...
                    <div className="col-md-6">
                        <div style={{width: '85%', margin: '0 auto'}}>
                            ...
                            <div style={{ alignItems: 'center', justifyContent: 'center', display: 'flex', marginTop: 10 }}>
                                ...
                                <NavLink to='/userlogin' style={{ backgroundColor: 'white', fontSize: 14, borderBottom: 'none', color: '#0F172A', fontWeight: 'bold', padding: 5 }}>Login</NavLink>
                            </div>
                        </div>
                    </div>
                </div>
