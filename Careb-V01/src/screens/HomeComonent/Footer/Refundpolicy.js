      ...
      <List>
        ...
        <ListItem>
          <ListItemText 
            ...
            secondary={
              <>
                <Typography>
                  Service fees at Caribbeaneaze are structured to align with the refund and cancellation policies set by our hosts. The basic fee for using Caribbeaneaze is 7% of the total booking cost. This fee structure is modified based on the host's chosen refund policy:
                </Typography>
                <ul>
                  <li>No Refund Policy: An additional 3% fee, making the total service fee 10% of the booking cost.</li>
                  <li>Partial Refund Policy: An additional 2% fee, totaling 9% of the booking cost.</li>
                  <li>Full Refund Policy: An additional 1% fee, totaling 8% of the booking cost.</li>
                </ul>
                <Typography>
        ...
        <ListItem>
          <ListItemText 
            ...
            secondary="Refund policies for services offered by affiliators are subject to the terms set by each affiliator and are independent of Caribbeaneaze’s policy."
          />
        </ListItem>
        <Divider />
        <ListItem>
